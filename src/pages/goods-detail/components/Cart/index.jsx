      ...
      <div className={styles.operation}>
        ...
        <div className={styles.item} style={{ marginLeft: '10rem' }}>
          <img
            ...
            src={'http://127.0.0.1:9090/assets/goods-detail/icon-shop.png'}
            alt=""
          />
        ...
        <div className={styles.item} style={{ marginLeft: '50rem' }}>
          <img
            className={styles.icon}
            src={'http://127.0.0.1:9090/assets/goods-detail/icon-service.png'}
            alt=""
          />
        ...
        <div className={styles.item} style={{ marginLeft: '50rem' }}>
          <img
            className={styles.icon}
            src={'http://127.0.0.1:9090/assets/goods-detail/icon-cart.png'}
            alt=""
          />
